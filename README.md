...
Onece you have run the polynomial_coefficients.py calculation for both temperature ranges for a given species, you can calculate heat capacity data from coefficients and produce a heat capacity comparison plot:
```
python Cp_plot.py
```
